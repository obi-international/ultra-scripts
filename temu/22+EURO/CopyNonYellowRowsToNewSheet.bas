Sub CopyNonYellowRowsToNewSheet()
    ...
    ' Delete "NotYellow" if it exists
    Application.DisplayAlerts = False
    On Error Resume Next
    ThisWorkbook.Worksheets("NotYellow").Delete
    On Error GoTo 0
    Application.DisplayAlerts = True

    ' Create new target sheet
    Set wsTarget = ThisWorkbook.Worksheets.Add
    wsTarget.Name = "NotYellow"
    ...
    MsgBox "Rows without yellow cells in column D copied to 'NotYellow' sheet.", vbInformation
End Sub
