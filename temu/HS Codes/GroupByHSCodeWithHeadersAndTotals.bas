...
Sub GroupByHSCodeWithHeadersAndTotals()
    ...
    For Each key In codeDict.Keys
        ...
        End With
        destRow = destRow + 2 ' add two empty rows
    Next key

    MsgBox "Data grouped, headed, and totaled by CODE in sheet '" & destSheetName & "'.", vbInformation
End Sub
