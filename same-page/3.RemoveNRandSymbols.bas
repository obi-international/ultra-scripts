Sub RemoveNRandSymbols()
    ...
    ' Prompt the user to enter the sheet name, defaulting to "original"
    sheetName = InputBox("Enter the sheet name (e.g., original):", "Sheet Name", "original")
    ...
    For i = 2 To lastRow ' Start from row 2 to skip headers
        ...
        ' Remove numbers and specified symbols
        ...
        processedText = Application.WorksheetFunction.Substitute(processedText, "!", "")
        processedText = Application.WorksheetFunction.Substitute(processedText, "@", "")
        processedText = Application.WorksheetFunction.Substitute(processedText, "ã", "")
        processedText = Application.WorksheetFunction.Substitute(processedText, "Ã", "")
        processedText = Application.WorksheetFunction.Substitute(processedText, "‡", "")
        processedText = Application.WorksheetFunction.Substitute(processedText, "§", "")
        processedText = Application.WorksheetFunction.Substitute(processedText, "'", "")
    ...
    MsgBox "Processing complete. Numbers and symbols removed from column H."
End Sub
